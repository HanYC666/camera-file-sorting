...
def resource_path(relative_path):
    ...
    try:
        # When bundled with PyInstaller, this will point to the temp folder
        base_path = sys._MEIPASS
    except AttributeError:
        # In development, it will point to the script directory
...
class App(tk.Tk):
    def __init__(self):
        ...
        # Load the home image dynamically
        self.home_image_path = resource_path("resources\image.png")
        try:
            self.home_image = ImageTk.PhotoImage(Image.open(self.home_image_path))
    ...
    def process_metadata(self, folder):
        ...
        exiftool_path = resource_path("exiftool.exe")  # Dynamic path for exiftool
                ...
                if not file.startswith("."):  # Ignore hidden files
                    ...
                    try:
                        ...
                        exiftool_output = subprocess.run(
                            [exiftool_path, "-Model", "-DateTimeOriginal", file_path],
